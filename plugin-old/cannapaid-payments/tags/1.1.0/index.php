...
function wc_cannapaid_gateway_init()
{
    class WC_Gateway_CannaPaid extends WC_Payment_Gateway
    {
        ...
        public function init_form_fields()
        {
            ...
            $this->form_fields = apply_filters('wc_cannapaid_form_fields', array(
                ...
                'fee_mode' => array(
                    'title' => __('Processing Fee Calculation', 'wc-gateway-cannapaid'),
                    'type' => 'select',
                    'label' => __('Processing Fee Calculation', 'wc-gateway-cannapaid'),
                    'options' => array(
                        'C' => __('Consumer pays processing fees'),
                        'M' => __('Merchant pays processing fees'),
                        'S' => __('Split fee between merchant and customer'),
                    ),
                    'default' => 'C'
                ),
