        ...
        <div class="formWrapper">
            ...
            <div class="fromBalance">
                ...
                <button id="selectCoinButton" type="button" data-toggle="modal" data-target="#selectCurrencyModal">
                    <img id="currencyImage" src="https://cryptologos.cc/logos/bitcoin-btc-logo.svg"/>
                    NULL
                </button>
            </div>
            ...
            <div>
                <!-- Modal -->
                <div class="modal fade" id="selectCurrencyModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-content" style="border-radius: 15px;">
                            ...
                            <div class="modal-body">
                                <div class="searchFieldWrapper">
                                    ...
                                    <div class="tokenNameHeader">
                                        <span>Token name</span>
                                        <div style="display: none;">
                                            <span class="badge badge-primary pointer" id="sorterToken">Primary</span>
                                        </div>
